...
_EN: Final[dict[str, str]] = {
    ...
    "dialog.settings.single_icon": "One icon for the whole library",
...
_CATALOGS: Final[dict[str, dict[str, str]]] = {
    ...
    "de": {
        ...
        "dialog.settings.single_icon": "Ein Symbol für die ganze Sammlung",
    ...
    "es": {
        ...
        "dialog.settings.single_icon": "Un solo icono para toda la biblioteca",
        "dialog.settings.column.series": "Serie",
        ...
        "dialog.settings.art.name": "Nombre",
